    ...
    <footer className="footer">
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            Professional pet care services with over 25 years of experience. 
            We provide comprehensive care for your beloved companions.
          </p>
          <div style={{
            display: 'flex',
            gap: 'var(--spacing-md)'
        ...
        <div>
          ...
          <ul style={{
            ...
            {['Services', 'About Us', 'Contact', 'Adoption', 'Community'].map((link) => (
      ...
      <div style={{
        ...
        <p style={{
          ...
          Made with ❤️ for your beloved pets
        </p>
      </div>
    </footer>
  );
